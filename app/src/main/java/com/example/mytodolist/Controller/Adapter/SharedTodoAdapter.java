...
import com.example.mytodolist.View.SharedTodoDetailActivity;

import java.util.ArrayList;

public class SharedTodoAdapter extends ArrayAdapter<TodoList> {

    public SharedTodoAdapter(Context context, ArrayList<TodoList> todoLists) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), SharedTodoDetailActivity.class);
